...
//     localStorage.getItem("appDarkMode") === "true"
//   );

//   useEffect(() => {
//     document.documentElement.classList.toggle("app-dark", dark);
//     localStorage.setItem("appDarkMode", dark);
//   }, [dark]);
...
//           <p className="settings-row-label">Dark app mode</p>
//           <p className="settings-row-description">
//             Dim panels across the app
//           </p>
//         </div>
//         <SettingsToggle checked={dark} onChange={setDark} />
//       </div>
//     </div>
//   );
// }
